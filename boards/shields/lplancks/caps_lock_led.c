...
#include <zmk/behaviors/behavior_rgb_underglow.h>
...
// ***************************************************************
// NUOVA FUNZIONE DI TEST: Eseguita una sola volta all'avvio
// ***************************************************************
static int caps_led_init(void) {
    // Questo messaggio DEVE comparire nei log se il file viene compilato.
    LOG_ERR(">>> IL MIO CODICE 'caps_lock_led.c' E' STATO COMPILATO CORRETTAMENTE! <<<");
    return 0;
}

// Registra la nostra funzione per essere eseguita all'avvio dell'applicazione.
